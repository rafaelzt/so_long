...
/*   Updated: 2025/02/19 22:33:00 by rzamolo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * This function is responsible for loading and rendering the various sprites 
 * used in the game, such as the wall, floor, collectibles, exit, and player.
 * 
 * It calls the `ft_render_sprites` function for each sprite to load and display
 ...
 * This function initializes the file paths for the various sprites used in the 
 * game, such as the wall, floor, collectibles, exit, and player. It then calls 
 * the `ft_load_game_sprites` function to load and render these sprites.
 *
 * @param game The game state structure containing the sprite information.
 */
